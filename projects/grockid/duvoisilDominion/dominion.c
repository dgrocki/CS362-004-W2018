...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
		case adventurer:
			return cardEffectAdventurer(handPos,currentPlayer,state);
		...
		case cutpurse:
            return cardEffectCutpurse(handPos,currentPlayer,state);
...
int cardEffectCutpurse(int handPos, int currentPlayer, struct gameState *state){
    int i,j,k;
...
int cardEffectAdventurer(int handPos, int currentPlayer, struct gameState *state){
	int drawntreasure;
	int cardDrawn;
